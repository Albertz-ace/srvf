...
module.exports.bootstrap = async function() {
  ...
  await User.createEach([
    { emailAddress: 'admin@example.com', FirstName: 'Ryan', LastName: 'Dahl', Phone_Number:'07000000', Role: 'Admin', Organization_level:'Conference', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('abc123') },
  ]);
