module.exports = {
  ...
  fn: async function ({emailAddress,FirstName,LastName,Organization_level,Phone_Number,Role}) {
    ...
    // (We always set the FirstName if provided.)
    console.log(FirstName);
    
    var valuesToSet = {emailAddress, FirstName,LastName,Organization_level,Phone_Number,Role};
    ...
    if (desiredEmailEffect === 'begin-change' || desiredEmailEffect === 'modify-pending-change') {
      await sails.helpers.sendTemplateEmail.with({
        ...
        templateData: {
          ...
          Phone_Number: Phone_Number||this.req.me.Phone_Number,
          Organization_level: Organization_level||this.req.me.Organization_level,
          Role: Role||this.req.me.Role,
